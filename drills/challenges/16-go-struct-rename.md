...
solution_keys:
  - '/UserRecord<Enter>ciwUser<Esc>n.n./uid<Enter>ciwid<Esc>n.n.n./uname<Enter>ciwusername<Esc>n.n.n./pwd<Enter>ciwpassword<Esc>/grp<Enter>ciwgroup<Esc>/newRecord<Enter>ciwnewUser<Esc>'
i18n:
  en:
    ...
    steps:
      ...
      - 'Rename field "uid" to "id" (4 occurrences)'
      - 'Rename field "uname" to "username" (4 occurrences)'
  ...
  ja:
    ...
    steps:
      ...
      - 'フィールド "uid" を "id" にリネーム（4 箇所）'
      - 'フィールド "uname" を "username" にリネーム（4 箇所）'
