...
- **`w` vs `e`**: `w` lands on the **start** of the next word; `e` lands on the **end** of the current/next word. With operators, prefer `e` — `ce` changes to the end of the word, leaving punctuation intact.
